...
for i in range(1000):
    ...
    as_command_vector = ['./../dev/Compilers/build_plain/bin/llvm-as', '-', '--o', f'test_{directory_name}.bc']
    with subprocess.Popen(
        as_command_vector,
        stdout=subprocess.PIPE,
        stderr=subprocess.STDOUT,
    ...
    opt_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-stats', f'test_{directory_name}.bc']
    opt_O1_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-O1', '-stats', f'test_{directory_name}.bc']
    opt_O2_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-O2', '-stats', f'test_{directory_name}.bc']
    opt_O3_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-O3', '-stats', f'test_{directory_name}.bc']
    opt_Os_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-Os', '-stats', f'test_{directory_name}.bc']
    opt_Oz_command_vector = ['./../dev/Compilers/build_plain/bin/opt', '-Oz', '-stats', f'test_{directory_name}.bc']
